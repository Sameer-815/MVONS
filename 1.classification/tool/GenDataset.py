...
class Stage2_Dataset(Dataset):
    def __init__(self, args, base_dir, split):
        ...
        if self.split   == "train":
            self._image_dir     = os.path.join(self._base_dir, 'training/')
            self._cat_dir       = os.path.join(self._base_dir, 'ca_attation/PM/PM_bn7/')
            self._cat_dir_a     = os.path.join(self._base_dir, 'ca_attation/PM/PM_b5_2/')
            self._cat_dir_b     = os.path.join(self._base_dir, 'ca_attation/PM/PM_b4_5/')
        elif self.split == 'val':
