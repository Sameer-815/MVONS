...
if __name__ == '__main__':
    ...
    model = 0
    weights_dict = 0
    weights_dict = torch.load('../checkpoints/stage1_checkpoint_trained_on_luad.pth')

    model = getattr(importlib.import_module("network.resnet38_cls"), 'Net_CAM')(n_class=4)
    ...
    for i in range(4):
        ...
        cam_show.save("F:/data/data_all/weak_suprvised_data/LUAD-HistoSeg/LUAD-HistoSeg/test/test_tmp/"+str(i)+'.png')
        test = 1
